async function sendEmail2() {
    ...
    try {
        ...
        const response = await fetch("https://project-2-louis-nordsoe.azurewebsites.net/api/sendEmail/user-email/" + email + "/email-content/" + formString + "/customer-name/" + fullName, {
            method: 'POST',
        });
